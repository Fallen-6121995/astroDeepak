            ...
            />
              ...
              <Col lg={4}>
                 <div className="servicesCard">
                    ...
                    <p>Want to lead with Calm and Deep
                      Presence? Become the effective
                      Leader you want to Be.</p>
              ...
              <Row className="mt-5">
                ...
                <Col md="6">
                 <div className="aboutRight">
                  <p>Over the last 15 years, I’ve coached Senior Leaders, CEOs, Start-up Founders, Coaches and Executives like you,
                   become highly effective leaders in every area of their life. </p>
                   <p>Through 1:1 Life Coaching services, I have helped leaders:</p>
                   <ul>
                    <li><span>Handle triggers, tough situations, and conflicts with Calm.</span></li>
                    <li><span>Become comfortable in their skin, by dropping self-doubts and self-judgements.</span></li>
                    <li><span>Express themselves fully and&nbsp; effectively in all situations, without any fear of judgement.</span></li>
                    <li><span>Lead effectively in life, both personally as well as professionally.</span></li>
                  </ul>
                  <p>Are you too ready to create a Shift your Consciousness? Let’s work together.</p>
                  <div className="mt-4">
                    <SectionBtn link="/" label="CONNECT WITH ME" />
                  </div>
                </div>
        ...
        <section className="ebookAbout secPadding">
           ...
           <Container>
              <Row className="mt-5">
                ...
                <Col md="6">
                 <div className="aboutRight">
                  <p> Do you overthink and over-analyze things? Are stressful thoughts and anxiety a regular part of your life? Do you want to have a
                   clear mind, enhance your decision-making ability, creativity, and productivity, so you can use your mind to your best capacity?</p>
                   <p>If Yes, then by practicing the simple and practical tools given in this book, you’ll be able to cultivate a new mind, and that too by devoting just three minutes in a day.</p>
               ...
               <Row className="mt-5">
                 <Col md="4">
                     <div className="testimonialCard">
                        <p>I LOVE IT SIMPLY THE WORK IT DOES IS SUPER CLEAN, I use it mainly for school and I highly recommend it if you need to clean the background noise of any audio, it is very fast and effective,
                           the cost is very appropriate for me does to have the complete songs. Very effective app 👍🏻 
                        </p>
                        <div className="d-flex align-items-center">
                          <div className="flex-shrink-0">
                            <img height="44" width="44" className="mr-2" src="/images/ebook_saloni.jpg" alt="saloni" />
                          </div>
